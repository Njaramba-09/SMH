...
import './App.css'
import { fetchGoals, addGoal, updateGoal, deleteGoal, depositToGoal } from './api'
...
function GoalItem({ goal, onDelete, onEdit }) {
  ...
  return (
    <div style={{
      border: '1px solid #ccc', borderRadius: 8, margin: 12, padding: 16, background: overdue ? '#ffeaea' : warning ? '#fffbe6' : '#fff'
    }}>
